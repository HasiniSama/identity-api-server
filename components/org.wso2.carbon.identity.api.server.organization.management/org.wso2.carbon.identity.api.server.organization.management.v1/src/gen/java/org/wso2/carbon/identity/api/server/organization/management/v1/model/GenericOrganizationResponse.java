...
@com.fasterxml.jackson.annotation.JsonSubTypes({
  @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = GetOrganizationResponse.class),
  @com.fasterxml.jackson.annotation.JsonSubTypes.Type(value = ShortOrganizationResponse.class)
})
@com.fasterxml.jackson.annotation.JsonTypeInfo(use = com.fasterxml.jackson.annotation.JsonTypeInfo.Id.DEDUCTION)
public interface GenericOrganizationResponse {
}
